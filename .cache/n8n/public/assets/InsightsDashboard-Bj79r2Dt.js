const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-BMm5-uje.js","assets/index-DuT-FIl1.js","assets/index-C6NR226r.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-BOWuHwMh.js","assets/chartjs.utils-Cl3MP1kj.js","assets/InsightsSummary-CpUOsQoR.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-rj5i1dCk.js","assets/InsightsChartFailed-n5LqWGkq.js","assets/InsightsChartFailureRate-DV991eOY.js","assets/InsightsChartTimeSaved-BvwxGS1S.js","assets/InsightsChartAverageRuntime-DV_Ju7Zp.js","assets/InsightsTableWorkflows-BAqDod9M.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, e9 as useModel, g2 as useInsightsStore, r as ref, gI as UNLICENSED_TIME_RANGE, gb as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, e2 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e1 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gJ as ElDialog, aA as usePageRedirectionHelper, _ as _export_sfc, aa as useRoute, gK as INSIGHT_TYPES, dl as defineAsyncComponent, af as watch, o as onMounted, ax as useDocumentTitle, m as N8nHeading, n as normalizeClass, dC as _sfc_main$4, c2 as resolveDynamicComponent, aU as __vitePreload, ap as useTelemetry, gL as TELEMETRY_TIME_RANGE } from "./index-DuT-FIl1.js";
import { I as InsightsSummary } from "./InsightsSummary-CpUOsQoR.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-BMm5-uje.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-BOWuHwMh.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-n5LqWGkq.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-DV991eOY.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BvwxGS1S.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-DV_Ju7Zp.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-BAqDod9M.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
