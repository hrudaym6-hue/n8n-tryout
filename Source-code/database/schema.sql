DROP TABLE IF EXISTS authorization_summary CASCADE;
...
CREATE TABLE cards (
    ...
    expiry_month VARCHAR(2) CHECK (expiry_month ~ '^(0[1-9]|1[0-2])$'),
    expiry_year VARCHAR(4) CHECK (expiry_year ~ '^(19[5-9][0-9]|20[0-9][0-9])$'),
    cvv_code VARCHAR(3),
...
CREATE TABLE authorization_summary (
    ...
    approved_auth_amount DECIMAL(12, 2) DEFAULT 0.00,
    declined_auth_count INTEGER DEFAULT 0,
    declined_auth_amount DECIMAL(12, 2) DEFAULT 0.00,
...
CREATE INDEX idx_authorization_summary_account ON authorization_summary(account_id);
...
('ADMIN001', 'Admin', 'User', '$2b$10$rKYGZHvEPNKJcpLlCh6W8.Y8pY5VhD3qEv/wGhUHx5t5YqZKx5p8K', 'A'),
('USER0001', 'John', 'Doe', '$2b$10$XHJ5EHWGhV0Y7TJvPZNPLuGnfKQj8hZQXz5TgWZP2L/NZqhPJ5gD6', 'U');
